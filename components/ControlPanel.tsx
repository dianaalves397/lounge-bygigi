  ...
  return (
    <main className="control-shell">
      <aside className="control-sidebar">
        ...
        <a className="pill" href="/lounge-control-926/shop-customization">
          Personalizar loja
        </a>
        <a className="pill" href="/lounge-control-926/pages">
          Páginas e políticas
        </a>
        ...
        {tab === "products" && (
          <Panel title="Produtos" eyebrow="inventory">
            <form onSubmit={saveProduct} className="form-grid">
              ...
              <TextField
                label="Categorias extra (IDs separados por vírgula)"
